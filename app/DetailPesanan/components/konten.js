...
const DetailPesanan = () => {
  ...
  if (loading) {
    return (
      <Typography className="flex justify-center items-center text-center text-black h-screen font-bold">
        Sedang memuat pesanan...
      </Typography>
    );
  }
              ...
              <div className="h-full flex flex-col">
                ...
                <div className="bg-white mx-1 space-y-1 sm:space-y-0 sm:mx-0 p-2 sm:p-3 rounded-lg border-gray-700 border-2 flex-grow overflow-y-auto scrollbar-none max-h-48">
                  <div className="flex gap-2">
                    ...
                    <Typography className="text-sm sm:text-lg font-bold text-gray-700">
